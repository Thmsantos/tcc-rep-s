...
function AvalicacoesPendentes() {
 ...
 /*  function chamar_nome() {
    let found_nome = array_cpf.find(element => element.toUpperCase() === buscar_nome.toUpperCase());
    console.log(found_nome)
    setNome(found_nome)
    console.log(buscar_nome)
    let found_cpf = array_cpf.indexOf(buscar_nome.toUpperCase());
    console.log(found_cpf)
    setCpf(array_nomes[found_cpf])
    setAparecerBusca('')
  } */
